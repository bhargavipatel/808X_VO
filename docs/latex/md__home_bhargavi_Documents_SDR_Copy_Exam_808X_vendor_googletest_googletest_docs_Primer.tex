...
See also\+: For more string comparison tricks (substring, prefix, suffix, and regular expression matching, for example), see the \hyperlink{_advanced_guide_8md}{Advanced Google Test Guide}.
...
Congratulations! You\textquotesingle{}ve learned the Google Test basics. You can start writing and running Google Test tests, read some \hyperlink{_samples_8md}{samples}, or continue with \hyperlink{_advanced_guide_8md}{Advanced\+Guide}, which describes many more useful Google Test features.
