...
\subsubsection[{\texorpdfstring{operator Matcher$<$ T $>$() const }{operator Matcher< T >() const }}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Matcher1 , typename Matcher2 $>$ template$<$typename T $>$ {\bf testing\+::internal\+::\+Either\+Of\+Matcher}$<$ Matcher1, Matcher2 $>$\+::operator {\bf Matcher}$<$ {\bf T} $>$ (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
