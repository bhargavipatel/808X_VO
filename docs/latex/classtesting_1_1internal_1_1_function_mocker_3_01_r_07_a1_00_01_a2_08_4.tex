...
\subsubsection[{\texorpdfstring{Invoke(\+A1 a1, A2 a2)}{Invoke(A1 a1, A2 a2)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename R , typename A1 , typename A2 $>$ {\bf R} {\bf testing\+::internal\+::\+Function\+Mocker}$<$ {\bf R}(A1, A2)$>$\+::Invoke (
...
\subsubsection[{\texorpdfstring{With(const Matcher$<$ A1 $>$ \&m1, const Matcher$<$ A2 $>$ \&m2)}{With(const Matcher< A1 > &m1, const Matcher< A2 > &m2)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename R , typename A1 , typename A2 $>$ {\bf Mock\+Spec}$<${\bf F}$>$\& {\bf testing\+::internal\+::\+Function\+Mocker}$<$ {\bf R}(A1, A2)$>$\+::With (
\begin{DoxyParamCaption}
