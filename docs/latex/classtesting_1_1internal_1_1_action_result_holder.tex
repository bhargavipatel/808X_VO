...
\subsubsection[{\texorpdfstring{Perform\+Action(const Action$<$ F $>$ \&action, const typename Function$<$ F $>$\+::\+Argument\+Tuple \&args)}{PerformAction(const Action< F > &action, const typename Function< F >::ArgumentTuple &args)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ template$<$typename F $>$ static {\bf Action\+Result\+Holder}$\ast$ {\bf testing\+::internal\+::\+Action\+Result\+Holder}$<$ {\bf T} $>$\+::Perform\+Action (
\begin{DoxyParamCaption}
\item[{const {\bf Action}$<$ F $>$ \&}]{action, }
\item[{const typename {\bf Function}$<$ F $>$\+::{\bf Argument\+Tuple} \&}]{args}
...
\subsubsection[{\texorpdfstring{Print\+As\+Action\+Result(\+::std\+::ostream $\ast$os) const }{PrintAsActionResult(::std::ostream *os) const }}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ virtual void {\bf testing\+::internal\+::\+Action\+Result\+Holder}$<$ {\bf T} $>$\+::Print\+As\+Action\+Result (
\begin{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{Unwrap()}{Unwrap()}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ {\bf T} {\bf testing\+::internal\+::\+Action\+Result\+Holder}$<$ {\bf T} $>$\+::Unwrap (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
