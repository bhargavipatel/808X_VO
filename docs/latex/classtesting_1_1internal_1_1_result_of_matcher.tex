...
\subsubsection[{\texorpdfstring{operator Matcher$<$ T $>$() const }{operator Matcher< T >() const }}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Callable$>$ template$<$typename T $>$ {\bf testing\+::internal\+::\+Result\+Of\+Matcher}$<$ Callable $>$\+::operator {\bf Matcher}$<$ {\bf T} $>$ (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
